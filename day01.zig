...
pub fn main() !void {
    ...
    var buff = try utils.readFile(allocator, "day01_input.txt");
    defer allocator.free(buff);

    var prev_value: usize = 0;
    var count: usize = 0;
    ...
    while (lines.next()) |line| {
        ...
        var n = std.fmt.parseInt(usize, line, 10) catch 0;
        if (n > prev_value and prev_value != 0) count += 1;
        prev_value = n;
    }
